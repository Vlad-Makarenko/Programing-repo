...
bool Test_NewListBackpack(){
    ...
    log_info("Test name: %s", __FUNCTION__ );
...
bool Test_InsertElement() {
    ...
    InsertElement(list, 1, 0, "green", 44, "Ukraine", 0, 1);
...
bool Test_SortListByCriterion(){
    ...
    SortListByCriterion(list, compareVolume ,1);
    ...
    SortListByCriterion(list, compareLd,1);
    ...
    SortListByCriterion(list, compareColor,1);
    ...
    SortListByCriterion(list, compareCountry,1);
    ...
    SortListByCriterion(list, comparePurpose,1 );
...
int main(){
    ...
    printf("\n|------TEST OF CREATING A NEW ELEMENT------|\n\n");
    result &= Test_NewListBackpack();
    if (result == true){
        printf("TEST RESULT: Good job so far\n");
    }else{
        printf("D'oh");
    }
    clock_t end1 = clock();
    double time_spent1 = (double)(end1 - begin1)/ CLOCKS_PER_SEC;
    printf(" | Time spent executing the Test_NewListBackpack %.10lf second(s)\n" , time_spent1);
    printf("\n|------NEW ITEM INSERT TEST------|\n\n");
    ...
    printf(" | Time spent executing the Test_InsertElement: %.10lf second(s)\n" , time_spent2);
    ...
    printf(" | Time spent executing the Test_DeleteElement: %.10lf second(s)\n", time_spent3);
    printf("\n|------ELEMENT SORTING TEST------|\n\n");
    ...
    printf(" | Time spent executing the Test_SortListByCriterion: %.10lf second(s)\n",  time_spent4);

//    printf("\n|------STRUCTURE SORTING TEST------|\n\n");
...
//    }
    ...
    printf("\n|------------------------------------|\n");
    printf("| Time taken to execute all tests: %.10lf second(s)", time_spent);
    printf("\n|------------------------------------|");
    return 0;
}