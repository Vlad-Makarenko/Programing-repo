 ...
 * Функція перевірки
 *
 * Функція перевіряє на корректність вхідний текст за допомогою регулярних виразів
 * @return повертає true - якщо текст пройшов провірку та false - якщо ні
 */
bool RegexChek(char a[1], char b[10], char c[3], char d[25], char f[1]);

/**
 * Функція виводу перевірки
 *
 * Функція виводить результат перевірки на корректність вхідного тексту за допомогою регулярних виразів
 * @param return_value змінна, в якій міститься резульат перевірки
 */
 ...
 * Функція виводу в консоль
 *
 * Функція виводить в консоль елементи списку, які мають поля з щонайменше двома словами
 * @param list список {@link ListBackpack} для зчитування
 */
