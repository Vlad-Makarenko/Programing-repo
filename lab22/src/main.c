...
int main() {
    ...
    for (int i = 0; i < 44; ++i) {
        ...
        printf(" |\t5. Вывести элементы, в которых поля стостоят из двух и более слов\n");
        printf(" |\t6. Выход\n");
        printf(" |-------------------------------------|\n");
        ...
        switch (index) {
            ...
            case 4:
                ...
                break;
            case 5:
                printf(" |\n |----------------------------СПИСОК элементов в которых поля стостоят из двух и более слов----------------------------|\n\n");
