...
bool Test_FindGermanVelourBackpack(){
    ...
    PrintForm1();
    cout << endl;
    LeatherBackpack * actual = list.FindGermanVelourBackpack();
    cout << endl;
...
bool Test_FindSuedeNoLiningBackpack(){
    ...
    PrintForm1();
    cout << endl;
    LeatherBackpack * actual = list.FindSuedeNoLiningBackpack();
    cout << endl;
...
bool Test_FindBlueMaxVolumeBackpack(){
    ...
    cout << endl << "Актуальный результат:" << endl;
    FabricBackpack * actual = (FabricBackpack*)list.FindBlueMaxVolumeBackpack();
    cout << endl;
